...
/*   Updated: 2021/01/21 21:19:16 by emabel           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** ОБЪЕКТ СТОЛ
**	*forks				вилки (семафор)
**  table_manager		семафор контролирующий прием пищи
*/
...
**	table				объект стол
**	write				семафор защищающий вывод write
**	death	    		семафор защищающий проверку жизни
**
