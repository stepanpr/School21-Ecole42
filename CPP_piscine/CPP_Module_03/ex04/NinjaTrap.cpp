...
{																							
	std::cout << "\e[0;32mNinjaTrap is ready 🤖 (default constructor)\e[0m" << std::endl;

}

NinjaTrap::NinjaTrap(std::string Name) : ClapTrap(60, 60, 120, 120, 1, Name, 60, 5, 0, 0)  		//конструктор с параметром
{																								
	std::cout << "\e[0;32mNinjaTrap is ready 🤖 (constructor)\e[0m" << std::endl;
}
...
NinjaTrap::NinjaTrap(NinjaTrap const & object)													//конструктор копирования
{
	...
	std::cout << "\e[0;32mNinjaTrap is ready 🤖 (copy constructor)\e[0m" << std::endl;
...
NinjaTrap &NinjaTrap::operator=(const NinjaTrap& rhs)											//оператор присваивания
{
	...
	this->set_Destroyed(0);
	std::cout << "\e[0;32mNinjaTrap is ready 🤖 (assignation operator)\e[0m" << std::endl;
	return *this;
}

NinjaTrap::~NinjaTrap()																			//деструктор
{
	std::cout << "\e[0;34mNinjaTrap is destroyed 💥 (destructor)\e[0m" << std::endl;
}
