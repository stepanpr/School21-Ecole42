...
{																									//запустится дефолтный конструктор ClapTrap
	...
	std::cout << "\e[0;32mFR4G-TP is ready 🤖 (default constructor)\e[0m" << std::endl;
}
...
{																									//запустится дефолтный конструктор ClapTrap
	...
	this->set_Destroyed(0);
	this->set_Energy_for_vaulthunter(1);
	std::cout << "\e[0;32mFR4G-TP is ready 🤖 (constructor)\e[0m" << std::endl;
}
...
FragTrap::FragTrap(FragTrap const & object)															//конструктор копирования
{
	...
	this->set_Destroyed(0);
	std::cout << "\e[0;32mFR4G-TP is ready 🤖 (copy constructor)\e[0m" << std::endl;
...
FragTrap &FragTrap::operator=(const FragTrap& rhs)													//оператор присваивания
{
	...
	this->set_Destroyed(0);
	std::cout << "\e[0;32mFR4G-TP is ready 🤖 (assignation operator)\e[0m" << std::endl;
	return *this;
}

FragTrap::~FragTrap()																			//деструктор
{
	std::cout << "\e[0;34mFR4G-TP is destroyed 💥 (destructor)\e[0m" << std::endl;
}
